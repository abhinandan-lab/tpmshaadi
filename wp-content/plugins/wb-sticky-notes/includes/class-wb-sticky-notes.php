...
class Wb_Sticky_Notes {
	 ...
	 * - Wb_Sticky_Notes_Public. Defines all hooks for the public side of the site.
	 *
	...
	private function load_dependencies() {
		 ...
		 * side of the site.
		 */
		require_once plugin_dir_path( dirname( __FILE__ ) ) . 'public/class-wb-sticky-notes-public.php';
	...
	private function define_public_hooks() {
		...
		$plugin_public = new Wb_Sticky_Notes_Public( $this->get_plugin_name(), $this->get_version() );
